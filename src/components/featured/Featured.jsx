  ...
  return (
    <>
      <div className="min-h-screen bg-[#FBF0F0]">
        ...
        <div className="flex flex-col lg:flex-row justify-center items-center px-5 lg:px-20 w-full gap-5 pb-5">
          {
      ...
      <div className="flex justify-center items-center min-h-screen bg-[#DFD3D3]">
        <div className="flex flex-col justify-center items-center bg-bg bg-cover bg-center h-[600px] w-full lg:w-1/2 bg-black">
